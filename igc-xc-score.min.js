'use strict';function _interopDefault(e){return(e&&(typeof e==='object')&&'default'in e)?e['default']:e}var fs=_interopDefault(require('fs'));var manufacturers = [
	{
		name: "Aircotec",
		long: "ACT",
		short: "I"
	...
	{
		name: "Cambridge Aero Instruments",
		long: "CAM",
		short: "C"
	},
	{
		name: "ClearNav Instruments",
		long: "CNI",
		short: null
	},
	{
	...
	{
		name: "Streamline Data Instruments",
		long: "SDI",
		short: "S"
	},
	{
		name: "Triadis Engineering GmbH",
		long: "TRI",
		short: "T"
	},
	{
	...
	{
		name: "SeeYou Recorder",
		long: "XCM",
		short: null
	}
];var manufacturers$1=/*#__PURE__*/Object.freeze({__proto__:null,'default': manufacturers});var commonjsGlobal = typeof globalThis !== 'undefined' ? globalThis : typeof window !== 'undefined' ? window : typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : {};
...
}var MANUFACTURERS = getCjsExportFromNamespace(manufacturers$1);var lookup = function lookup(id) {
...
Object.defineProperty(GenericCollection.prototype,"size",GenericCollection._sizePropertyDescriptor);var weakMap = createCommonjsModule(function (module) {
...
});var weakMap$1 = (typeof WeakMap !== 'undefined') ? WeakMap : weakMap;var shimObject = Object;
...
var changeDescriptor_4 = changeDescriptor.WillChangeListenersRecord;// Object property descriptors carry information necessary for adding,
...
class Solution {
    ...
    do_score(distance_fn) {
        ...
        let tp = [];
        for (let r in this.ranges)
            tp[r] = new Point$1(this.opt.flight, this.ranges[r].center());
        
        this.scoreInfo = this.opt.scoring.score(tp, this.opt, distance_fn || Point$1.prototype.distanceEarth);
    ...
    geojson() {
        ...
        if (this.opt.config && this.opt.config.debug) {
            for (let r in this.ranges)
                features.push((new Box$1(this.ranges[r], this.opt.flight))
                    .geojson('box' + r, {
                        id: 'box' + r,
                        a: this.ranges[r].a,
                        b: this.ranges[r].b
        ...
        features.push(new Point$1(this.opt.flight, 0)
            .geojson('launch', {
                id: 'launch',
                r: 0,
                timestamp: this.opt.flight.fixes[0].timestamp
            }));
        features.push(new Point$1(this.opt.flight, this.opt.flight.fixes.length - 1)
            .geojson('land', {
                id: 'land',
...
MapChangeDescriptor.prototype = new ObjectChangeDescriptor$2();
...
MapChangeListenersRecord.prototype = new ChangeListenersRecord$1();
...
MapWillChangeListenersRecord.prototype = new ChangeListenersRecord$1();
...
var ObjectsDispatchesMapChanges = new weakMap$1(),
    ...
    dispatchesChangesMethodName$1 = "dispatchesMapChanges",
...
}const Flatbush$1 = Flatbush.default ? Flatbush.default : Flatbush;
...
function maxDistanceNRectangles(boxes) {
    ...
    let path = [];
    for (let r in boxes) {
        if (boxes[r] instanceof Box$2) {
            vertices[r] = boxes[r].vertices();
            minx = Math.min(minx || Infinity, boxes[r].x1);
            miny = Math.min(miny || Infinity, boxes[r].y1);
            maxx = Math.max(maxx || -Infinity, boxes[r].x2);
            maxy = Math.max(maxy || -Infinity, boxes[r].y2);
        } else if (boxes[r] instanceof Point$2) {
            vertices[r] = [boxes[r]];
...
function findClosestPairIn2Segments(p1, p2, opt) {
    ...
    const rtree = new Flatbush$1(p1 + 1, 8);
...
function findFurthestPointInSegment(sega, segb, target) {
    let points;
    if (target instanceof Box$2)
        points = target.vertices();
    else if (target instanceof Point$2)
        points = [target];
    else
    ...
    for (let v of points) {
        ...
        if (fVpoint === undefined) {
            for (let p = sega; p <= segb; p++) {
                ...
                if (target instanceof Box$2 && target.intersects(f)) {
                    intersecting = true;
                    continue;
                }
...
function init(opt) {
    ...
    for (let r in opt.flight.fixes)
        flightPoints[r] = new Point$2(opt.flight, r);
}
...
var geom = {
    ...
    isTriangleClosed,
    init
};const Box$3 = foundation.Box;


function boundFlatTriangle(ranges, opt) {
    let boxes = [];
    for (let r of [0, 1, 2])
        boxes[r] = new Box$3(ranges[r], opt.flight);
...
var scoringRules_config = rules;const Solution$1 = solution.Solution;
    ...
    while (true) {
        ...
        for (let scoringType of scoringTypes) {
            ...
            let solutionRoot = new Solution$1([
                new Range$1(0, flight.fixes.length - 1),
                new Range$1(0, flight.fixes.length - 1),
                new Range$1(0, flight.fixes.length - 1)
            ], opt);
        ...
        do {
            ...
            if (best.optimal) {
                best.do_score(Point$3.prototype.distanceEarthHP);
...
var solver_1 = solver;var name = "igc-xc-score";
var version = "1.1.99-git";
var description = "igc-xc-score is a paragliding and hang-gliding XC scoring program in vanilla JS";
var main = "index.js";
var directories = {
	test: "test",
	example: "www"
...
var scripts = {
	...
	eslint: "eslint geom.js index.js scoring.js scoring-rules.config.js solution.js solver.js test.js foundation.js util.js vincentys.js",
	...
	build: "rollup -c && npm run nexe_all && npm run www",
	preversion: "npm test",
	version: "npm run build && git add package.json igc-xc-score.min.js",
...
var author = "Momtchil Momtchev <momtchil@momtchev.com>";
var license = "LGPL-3.0-or-later";
var bugs = {
	url: "https://github.com/mmomtchev/igc-xc-score/issues"
};
var homepage = "https://github.com/mmomtchev/igc-xc-score#readme";
var dependencies = {
	collections: "^5.1.10",
	flatbush: "^3.3.0",
	"igc-parser": "^0.5.0",
...
};var _package$1=/*#__PURE__*/Object.freeze({__proto__:null,name: name,version: version,description: description,main: main,directories: directories,scripts: scripts,repository: repository,keywords: keywords,author: author,license: license,bugs: bugs,homepage: homepage,dependencies: dependencies,devDependencies: devDependencies,'default': _package});var require$$1 = getCjsExportFromNamespace(_package$1);const Solution$2 = solution.Solution;
...
if (config.scoring && !scoringRules_config[config.scoring]) {
...
if (config.pipe) {
    ...
    if (!process.argv[2]) {
        console.log(`igc-xc-score ${require$$1.version}`);
...
const it = solver_1(flight, scoringRules_config[config.scoring] || scoringRules_config.FFVL, config);
/* 
 * BEWARE!
...
do {
    ...
    if (best === undefined || !Solution$2.prototype.contentEquals(newbest.value, best)) {
        best = newbest.value;
        if (!config.quiet)
